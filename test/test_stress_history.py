...
#         )
#         self.assertEqual(history.tuesday_date, history.monday_date +
# timedelta(days=1))
#         self.assertEqual(
#             history.wednesday_date, history.monday_date + timedelta(days=2)
#         )
#         self.assertEqual(history.thursday_date, history.monday_date +
# timedelta(days=3))
#         self.assertEqual(history.friday_date, history.monday_date +
# timedelta(days=4))
#         self.assertEqual(history.saturday_date, history.monday_date +
# timedelta(days=5))
#         self.assertEqual(history.sunday_date, history.monday_date +
# timedelta(days=6))
...
#     # test_draw_stress_history_current_date only works locally and not on
# github.
