...
#         frame = Mock()
#         mock_date = MagicMock()
#         self.main.manager_menu_choice(frame, "MAIN_MENU", "test_user",
# mock_date,  self.reminder)
...
#         frame = Mock()
#         mock_date = MagicMock()
#         self.main.manager_menu_choice(frame, "BREATHE", "test_user",
# mock_date)
#         frame.pack_forget.assert_called_once()
...
#                 )
#                 frame.pack_forget.assert_called_once()
#                 if menu_choice == "USER_MENU":  # Uses different args than
# the rest.
#                     mock_user.assert_called_once_with(True, "test_user",
# self.window)
#                 elif (
...
#                 getattr(mock_class.return_value, method_name).
# assert_called_once()
